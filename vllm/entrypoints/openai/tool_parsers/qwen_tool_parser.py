...
class QwenToolParser(ToolParser):
    """
    Tool call parser for Qwen models using Hermes-style extraction: finds all JSON objects with 'name' and 'arguments' fields (not a list, no tags).
    """
